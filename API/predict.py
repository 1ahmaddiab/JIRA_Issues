...
def predict_resolution_date(df_avro_issues, key=None):
    ...
    # Handling NaNs (here some NaNs exist only in the description length feature)
    ...
    # I make sure 'created' is datetime and 'days_since_created' is timedelta to add them to get resolutiondate datetime
